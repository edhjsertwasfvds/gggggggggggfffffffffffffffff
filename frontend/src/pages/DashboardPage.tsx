...
import { Users, Shield, Activity, BarChart3, TrendingUp, Clock, Award, Zap } from 'lucide-react';
...
export default function DashboardPage() {
  ...
  const statCards = [
    ...
    {
      label: 'Groups Active',
      value: Object.keys(stats?.staff_by_role || {}).length,
      icon: BarChart3,
    ...
    <div className="space-y-8">
      ...
      >
        ...
        <p className="text-gray-400">
          {user?.staff_role && user.staff_role !== 'Пользователь'
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {statCards.map((card, i) => (
          <motion.div
            ...
            whileHover={{ y: -4, boxShadow: '0 10px 40px rgba(79, 124, 255, 0.1)' }}
